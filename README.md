...
- `post1/` through `post10/` — standalone article pages
...
Run `node scripts/rebuild-articles.mjs` after changing article-shell metadata or shared navigation for posts 1–8. Posts 9 and 10 have standalone shells with article-specific graphics and evidence styling; maintain its metadata and navigation in their respective `post9/index.html` and `post10/index.html` files. Article prose remains between the generated content markers in each post.
